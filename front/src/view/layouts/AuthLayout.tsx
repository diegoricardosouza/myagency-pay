...
export function AuthLayout() {
  ...
  return (
    <div className="flex flex-col justify-center w-full lg:grid lg:min-h-[600px] lg:grid-cols-2">
      <div className="flex lg:h-screen items-center justify-center py-12 px-5 order-2 pt-0 lg:pt-12">
